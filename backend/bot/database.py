...
class Proposta(Base):
    # Propostas de orçamento geradas automaticamente pela IA a partir do pedido do cliente
    ...
    proposta_texto = Column(Text, default='')  # Texto da proposta enviada ao cliente
    modelo = Column(String(50), default='')  # Modelo de IA usado na geração
    created_at = Column(DateTime, default=datetime.utcnow)
